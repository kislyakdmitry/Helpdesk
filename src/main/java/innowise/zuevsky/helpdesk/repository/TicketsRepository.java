...
public interface TicketsRepository
  ...
  @Query(
      """
            ...
            """)
  Page<Ticket> findTicketsForManager(
      Long userId,
      Collection<State> statesOfManagerApprover,
      Long ticketId,
      String ticketName,
      LocalDate ticketDesiredDate,
      List<State> ticketStates,
      List<Urgency> ticketUrgencies,
      Pageable pageable);
  ...
  @Query(
      """
            ...
            AND (t.urgency IN :ticketUrgencies)
            """)
  Page<Ticket> findTicketsForEngineer(
      Long userId,
      Collection<State> statesOfEngineerAssignee,
      Long ticketId,
      String ticketName,
      LocalDate ticketDesiredDate,
      List<State> ticketStates,
